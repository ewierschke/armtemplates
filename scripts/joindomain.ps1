...
try {
    Invoke-Webrequest "https://raw.githubusercontent.com/ewierschke/armtemplates/runwincustdata/scripts/${nextscript}.ps1" -Outfile "${JoinDomainDir}\${nextscript}.ps1"
} catch {
    # Unhandled exception, log an error and exit!
...
if ($PSVersionTable.psversion.major -ge 4) {
    $A = New-ScheduledTaskAction -Execute "powershell.exe" -Argument "-ExecutionPolicy Bypass ${JoinDomainDir}\${nextscript}.ps1"
