...
New-Item -Path $domainwinwatchstoredeploypassDir -ItemType "directory" -Force 2>&1 > $null

# Get the next script
Invoke-Webrequest "https://raw.githubusercontent.com/ewierschke/armtemplates/runwincustdata/scripts/${nextscript}.ps1" -Outfile "${domainwinwatchstoredeploypassDir}\${nextscript}.ps1";
...
if ($PSVersionTable.psversion.major -ge 4) {
    $A = New-ScheduledTaskAction -Execute "powershell.exe" -Argument "-ExecutionPolicy Bypass ${domainwinwatchstoredeploypassDir}\${nextscript}.ps1"
